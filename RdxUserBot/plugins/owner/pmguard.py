...
async def pm_approve(client, message):
    ...
    if message.reply_to_message:
        ...
        if replied_user.is_self:
            return await message.edit("ʏᴏᴜ ᴄᴀɴ'ᴛ ᴅᴏ ᴛʜᴀᴛ ᴛᴏ ʏᴏᴜʀsᴇʟғ.")
...
async def block_user_func(client, message):
    ...
    await message.edit("sᴜᴄᴄᴇssғᴜʟʟʏ ʙʟᴏᴄᴋ ᴜsᴇʀ!!!")
...
async def unblock_user_func(client, message):
    if message.chat.type == ChatType.PRIVATE:
        ...
        if not message.reply_to_message:
            return await message.edit("ʀᴇᴘʟʏ to ᴜsᴇʀ ᴍᴇssᴀɢᴇ.")
        reply = message.reply_to_message
        replied_user = reply.from_user
        if replied_user.is_self:
            return await message.edit("ʏᴏᴜ ᴄᴀɴ'ᴛ ᴅᴏ ᴛʜᴀᴛ ᴛᴏ ʏᴏᴜʀsᴇʟғ.")
    ...
    await message.edit("ᴜɴʙʟᴏᴄᴋ ᴜsᴇʀ sᴜᴄᴄᴇssғᴜʟʟʏ !")
